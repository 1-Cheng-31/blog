...
//        String projectPath = System.getProperty("user.dir");// 获取当前用户的目录
        globalConfig
                .setOutputDir("D:/school/IntelliJ IDEA/project/springboot/project/blog-parent/Mybatis-Plus/src/main/java")// 输出文件路径
                .setAuthor("设置作者名字")// 设置作者名字
        ...
        /**
         * 2、数据源配置
         * 127.0.0.1:3306/demo   中的demo是数据库的名称
         */
        DataSourceConfig dataSourceConfig = new DataSourceConfig();// 创建数据源配置
        dataSourceConfig
                .setUrl("jdbc:mysql://localhost:3306/blog?useSSL=false&useUnicode=true&characterEncoding=UTF-8") //TODO 设置数据库连接
        ...
        strategyConfig
                ...
                .setInclude("ms_article","ms_sys_user","ms_tag","ms_article_tag")       //TODO 设置要映射的表
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return "D:/school/IntelliJ IDEA/project/springboot/project/blog-parent/Mybatis-Plus/src/main/resources/mapper/"
